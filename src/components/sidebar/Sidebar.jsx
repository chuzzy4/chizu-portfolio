...
import dp from '../images/dps.jpeg';
...
export default function Sidebar() {
  ...
  const iconList = [
    {
      component: github,
      href: 'https://github.com/chuzzy888'
    },
    {
      component: linkedin,
    ...
    {
      component: gmail,
      href: 'mailto:chizupraise31@gmail.com'
    }
  ];
  const item = {
  ...
  return (
    <div className='sidebar'>
      ...
      <div
        ...
        className='tagtop'
      >
        Made with <a href='#' className='fa fa-heart heart'></a> by chizu praise.
      </div>
    </div>
  );
}
